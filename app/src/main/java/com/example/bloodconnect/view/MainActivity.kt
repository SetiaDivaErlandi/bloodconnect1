package com.example.bloodconnect.view
...
import com.example.bloodconnect.viewmodel.ViewModelFactory
import com.example.bloodconnect.view.navigation.Screen
import com.example.bloodconnect.view.screen.*
import com.example.bloodconnect.view.theme.BloodconnectTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        val userPreferences = com.example.bloodconnect.model.local.UserPreferences(this)
        setContent {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Screen.Profile.route) {
                ProfileScreen(navController, bloodViewModel, authViewModel)
            }
